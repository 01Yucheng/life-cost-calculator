...
def get_github_repo():
    try:
        from github import Auth  # 导入最新认证模块
...
def load_data_from_github():
    ...
    try:
        ...
        if repo:
            ...
            # 使用 utf-8-sig 处理 Excel 生成的 BOM 字符
...
# B. AI 输入区
with st.expander("➕ 录入新房源 (支持 AI 扫描图片)", expanded=True):
